...
type
  TRLLocaleStrings = record
    ...
    {@var LS_PageSelectionHint - Variável de internacionalização para "Separe com ponto-e-vírgula os números ou intervalos de páginas a imprimir. Ex.: 1;3;5-12;14". :/}
...
var
  EnglishStrings: TRLLocaleStrings = (
    ...
    LS_PageSelectionHint: 'Separate page numbers or page intervals with ";". i.e.: 1;3;5-12;14';
...
var
  PortugueseStrings: TRLLocaleStrings = (
    ...
    LS_PageSelectionHint: 'Separe com ponto-e-vírgula os números ou intervalos de páginas a imprimir.' + sLineBreak + 'Ex.: 1;3;5-12;14';
...
var
  FrenchStrings: TRLLocaleStrings = (
    ...
    LS_PageSelectionHint: 'Séparé des numéros de page ou des intervalles avec ";". p.ex.: 1;3;5-12;14';
...
var
  SpanishStrings: TRLLocaleStrings = (
    ...
    LS_PageSelectionHint: 'Separar con ";" los números o rangos de páginas para imprimir. Ex.: 1;3;5-12;14';
...
var
  ItalianStrings: TRLLocaleStrings = (
    ...
    LS_PageSelectionHint: 'Separa numeri di pagina o intervallo con ";". i.e.: 1;3;5-12;14';
...
var
  CzechStrings: TRLLocaleStrings = (
    ...
    LS_PageSelectionHint: 'Oddìlené èísla stránek støedníkem nebo rozmezí stránek s pomlèkou. tj.: 1;3;5-12;14';
    LS_DefaultJobTitle: 'Report "%s"';
  ...
  GermanStrings: TRLLocaleStrings = (
    ...
    LS_PageSelectionHint: 'Seiten oder Seitenbereiche mit ";" trennen. Z.B.: 1;3;5-12;14';
